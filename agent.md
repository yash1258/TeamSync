...
6. Planning Phase 2 uses temporary derived data:
   - `PlanningView` now includes a native issue lane (`issues` table) with status/project filters, multi-select batch actions, and an issue detail drawer for relation management (`issueRelations`)
